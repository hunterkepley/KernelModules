...
#include <linux/fs.h>
#include <asm/uaccess.h> /* for pus_user */

MODULE_AUTHOR("Hunter Kepley");
MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("Basic char device module");
...
static int device_release(struct inode *inode, struct file *file) {
	...
	/*
	 * Decrement the usage counter, or else once you've opened the file,
...
static ssize_t device_read(struct file *filp, /* see include/linux/fs.h */
	...
	while(length && *msg_Ptr) {
		 ...
		 * so "*" assignment won't work. We have to use
		 * put_user which copies data from the kernel data
